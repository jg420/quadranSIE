...
function fc_affiche_infos_central(id) {
...
function fc_affiche_equipements_central(id) {
    
}
function fc_affiche_prestaires_central(id) {
    
}
function fc_affiche_apercus_central(id) {}
